...
**Theme:** complete the v0915 task series (cycle 80 folded task02/04/05/07; this cycle lands the remaining 6 files) — the largest single fold batch to date: 204 tests, 17 receiver placements across 14 canonical files, executed as two bounded subagent batches on one branch.

- **Items: 6 fold sources → 14 canonical receivers (17 source-subset placements); 204 tests moved verbatim; 6 versioned files deleted; src/kb/ untouched.**
