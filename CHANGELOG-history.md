...
**src/kb/ changes:** 3 files — `lint/augment/tier_boundary.py` (NEW), `lint/augment/orchestrator.py` (inline definition → re-export + `required_keys` plumb at the auto_ingest call site), `lint/augment/proposer.py` (2 call-site re-gates + imports).
