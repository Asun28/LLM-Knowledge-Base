...
- **Batch B (91 tests, 26 placements / 16 receivers):** `v090` (43) → mcp_core(11)/mcp_browse_health(7)/mcp_quality_new(4)/query(4)/ingest(7)/llm(1)/models(2)/compile(1)/graph(1)/utils_text(2)/review(3 — `test_review.py` is the subject-named canonical `pair_page_with_sources` host); `v099_phase39` (33) → query(6)/ingest(9)/compile(6)/graph(6)/config(5)/lint(5 — `TestVerdictTrends` whole class, majority subject kb.lint.trends); `v09_cycle5_fixes` (15) → mcp_core(3)/query(1)/ingest(2)/llm(1)/utils_text(3)/config(1)/lint_verdicts(1)/cli(2)/conftest_sandbox_guard(1).
