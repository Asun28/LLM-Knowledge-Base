...
Current shipped phases and per-cycle tallies live in `CHANGELOG.md` (Quick Reference table at top of `[Unreleased]`). Latest full-suite count: 2688 passed + 8 skipped (cycle 20 after R1 PR fixes; 2696 collected — one `@pytest.mark.skipif` Windows tilde test remains uncollected on non-Win32). Open work and deferred-feature roadmap live in `BACKLOG.md`.
