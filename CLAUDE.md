...
- **State:** v0.11.0 · 3005 tests / 257 files (2985 passed + 20 skipped on Windows local; ubuntu-latest CI strict-gated since cycle 36; windows-latest CI matrix deferred to cycle-37 follow-up per second hang at threading.py:355). Shipped → `CHANGELOG.md` (index) + `CHANGELOG-history.md` (per-cycle detail). Open → `BACKLOG.md`.
