...
- **State:** v0.11.0 · 3025 tests / 237 files (3014 passed + 11 skipped on Windows local; ubuntu-latest CI strict-gated since cycle 36; windows-latest CI matrix deferred to cycle-50+ per cycle-36 L1 CI-cost discipline + cycle-39..49 carry-over). Shipped → `CHANGELOG.md` (index) + `CHANGELOG-history.md` (per-cycle detail). Open → `BACKLOG.md`.
