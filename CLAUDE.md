...
- **State:** v0.11.0 · 3025 tests / 241 files (3014 passed + 11 skipped on Windows local; ubuntu-latest CI strict-gated since cycle 36; windows-latest CI matrix deferred to cycle-49+ per cycle-36 L1 CI-cost discipline + cycle-39..48 carry-over). Shipped → `CHANGELOG.md` (index) + `CHANGELOG-history.md` (per-cycle detail). Open → `BACKLOG.md`.
