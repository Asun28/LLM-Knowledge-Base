...
- **State:** v0.10.0 · 2921 tests / 253 files (2910 passed + 10 skipped + 1 xfailed). Shipped → `CHANGELOG.md` (index) + `CHANGELOG-history.md` (per-cycle detail). Open → `BACKLOG.md`.
...
- **Latest full-suite:** 2921 tests / 253 files · 2910 passed + 10 skipped + 1 xfailed (cycle 33 added +19 passing path-leak/idempotency regressions and +1 xfail-strict marker for the open `sanitize.py` ordinary-UNC residual).
...
Full suite: 2921 tests / 253 files (2910 passed + 10 skipped + 1 xfailed). New tests per cycle go in versioned files (e.g. `test_cycle20_errors_taxonomy.py`). Per-cycle test-file details → `CHANGELOG-history.md`.
