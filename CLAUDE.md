...
- **State:** v0.11.0 · 3012 tests / 258 files (2991 passed + 21 skipped on Windows local; ubuntu-latest CI strict-gated since cycle 36; windows-latest CI matrix deferred to cycle-38+ per cycle-36 L1 CI-cost discipline). Shipped → `CHANGELOG.md` (index) + `CHANGELOG-history.md` (per-cycle detail). Open → `BACKLOG.md`.
