...
- **State:** v0.10.0 · 2901 tests / 251 files (2891 passed + 10 skipped). Shipped → `CHANGELOG.md` (index) + `CHANGELOG-history.md` (per-cycle detail). Open → `BACKLOG.md`.
...
- **Latest full-suite:** 2901 tests / 251 files · 2891 passed + 10 skipped (includes +1 stagger-integration test from PR review R1 Codex MAJOR 2).
...
Full suite: 2901 tests / 251 files (2891 passed + 10 skipped). New tests per cycle go in versioned files (e.g. `test_cycle20_errors_taxonomy.py`). Per-cycle test-file details → `CHANGELOG-history.md`.
