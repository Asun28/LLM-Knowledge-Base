...
- **State:** v0.11.0 · 3027 tests / 244 files (3016 passed + 11 skipped on Windows local; ubuntu-latest CI strict-gated since cycle 36; windows-latest CI matrix deferred to cycle-41+ per cycle-36 L1 CI-cost discipline + cycle-39/40/41/42/43/44/45 carry-over). Shipped → `CHANGELOG.md` (index) + `CHANGELOG-history.md` (per-cycle detail). Open → `BACKLOG.md`.
