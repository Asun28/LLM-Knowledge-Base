...
- **Cycle 59 (folds — dev-codex-gate/subagent cycle)** — Items: 20 fold ACs / 0 src files / 20 test files DELETED via fold (`test_v0917_rewriter.py`, `test_v0917_raw_fallback.py`, `test_v0917_layered_context.py`, `test_v0917_hybrid.py`, `test_v0917_embeddings.py`, `test_v01004_query_correctness.py`, `test_v01005_query_perf_docs.py`, `test_v0917_stale_query.py`, `test_v0917_dedup.py`, `test_v4_11_markdown.py`, `test_v5_augment_config.py`, `test_v01002_consolidated_constants.py`, `test_v5_verdict_augment_type.py`, `test_v5_autogen_prefixes.py`, `test_v01010_lint_fixes.py`, `test_v0917_contradiction.py`, `test_v0917_evidence_trail.py`, `test_v01006_compile_fixes.py`, `test_v4_11_cli.py`, `test_v4_11_mcp.py`) | Tests: 3021 preserved (full Windows local: 3009 passed + 12 skipped; collect: 3021) | Files: 200 → 180 (-20) | Scope: pure tests/ hygiene; zero `src/kb/` changes; zero dependency changes. Receivers: `test_query.py` (10 folds), `test_config.py` (2), `test_lint.py` (3), `test_ingest.py` (2), `test_compile.py` (1), `test_cli.py` (1), `test_mcp_core.py` (1). Direct MiMo + DeepSeek CLIs and subagents were used under `dev-codex-gate`; reviewer drift findings fixed before commit. Step commits: `154e41c` test fold, `5471336` receiver whitespace cleanup, and the cycle-59 docs sync. | Detail: see CHANGELOG-history.md cycle-59 + docs/superpowers/decisions/2026-05-03-cycle-59-plan.md
