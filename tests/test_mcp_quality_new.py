...
# ── Cycle 10 AC1/AC1b — quality degradation warnings (folded from test_cycle10_quality.py) ─

# Cycle 36 AC5 — `kb.config.WIKI_DIR` mirror is added to the existing 3-module
