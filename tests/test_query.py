...
# -- Cycle 62 fold from test_v0917_rewriter.py --
"""Tests for multi-turn query rewriting (Phase 4)."""

from unittest.mock import patch  # noqa: E402,F401,F811

from kb.query.rewriter import rewrite_query  # noqa: E402,F401,F811
...
# -- Cycle 62 fold from test_v0917_raw_fallback.py --
"""Tests for raw-source fallback retrieval (Phase 4)."""

from kb.query.engine import search_raw_sources  # noqa: E402,F401,F811
...
# -- Cycle 62 fold from test_v0917_layered_context.py --
"""Tests for layered context assembly (Phase 4)."""

from kb.query.engine import _build_query_context  # noqa: E402,F401,F811
...
# -- Cycle 62 fold from test_v0917_hybrid.py --
"""Tests for RRF fusion and hybrid search (Phase 4)."""

from kb.query.hybrid import rrf_fusion  # noqa: E402,F401,F811
...
# -- Cycle 62 fold from test_v0917_embeddings.py --
"""Tests for embedding wrapper and vector index (Phase 4)."""

from kb.query.embeddings import VectorIndex, embed_texts  # noqa: E402,F401,F811
...
# -- Cycle 62 fold from test_v01004_query_correctness.py --
...
# -- Cycle 62 fold from test_v01005_query_perf_docs.py --
...
# -- Cycle 62 fold from test_v0917_stale_query.py --
"""Tests for stale truth flagging at query time (Phase 4)."""

import os  # noqa: E402,F401,F811
import time as _cycle62_time  # noqa: E402,F401,F811
from datetime import date, timedelta  # noqa: E402,F401,F811

from kb.query.engine import _flag_stale_results  # noqa: E402,F401,F811
...
class TestFlagStaleResults:
    ...
    def test_does_not_flag_fresh_page(self, tmp_project, create_wiki_page, create_raw_source):
        ...
        old_ts = _cycle62_time.time() - 86400 * 60
...
# -- Cycle 62 fold from test_v0917_dedup.py --
"""Tests for 4-layer search dedup pipeline (Phase 4)."""

from kb.query.dedup import dedup_results  # noqa: E402,F401,F811
...
# -- Cycle 62 fold from test_v4_11_markdown.py --
...
from kb.query.formats.markdown import render_markdown  # noqa: E402,F401,F811
